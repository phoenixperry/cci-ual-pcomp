			...
			editor.on('click', function(e) {
				...
				if (/^(IMG|HR)$/.test(e.nodeName)) {
					try {
						...
						// Evernote change: Blink started throwing an error here sometime in 2017.
						// This issue appears to be fixed in TinyMCE v4.6.0, released 2017-05-04, but
						// the code has diverged too greatly to pick up the proper fix.
					}
				}
